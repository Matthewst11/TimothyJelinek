...
if (window.addEventListener) {
 ...
 function validateRequired() { 
        ...
        try {      
            for (var i =0; i < elementCount; i++) { 
              // validate all required input elements in fieldset1
        ...
        if (currentElement.value ==="") {
            ...
            currentElement =document.querySelectorAll("select")[0];      // validate state select element
 ...
 function createEventListeners() { 
        ...
        if (orderForm.addEventListener) { 5
