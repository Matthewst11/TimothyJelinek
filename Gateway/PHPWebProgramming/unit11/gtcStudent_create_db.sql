...
-- EDIT THIS FILE ON LINES 7,8,55, 56
-- TO INCLUDE YOUR USERNAME_ BEFORE THE DATABASE NAME        ********************

-- Create the my_guitar_shop1 database
-- DROP DATABASE IF EXISTS my_guitar_shop1;
CREATE DATABASE tjelinek_myguitarshop1;
USE tjelinek_myguitarshop1;  -- MySQL command
...
CREATE DATABASE tjelinek_myguitarshop2;
USE tjelinek_myguitarshop2;
